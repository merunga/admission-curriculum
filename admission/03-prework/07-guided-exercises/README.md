...
1. **Edad en segundos**: Crea una web que pida al usuario su edad en años,
   ...
   `document.write()`.
   [Comenzar](https://lab.cs50.io/merunga/admission-curriculum/rediseno-prework-fe/admission/03-prework/07-guided-exercises/sandboxes/01-edad-en-segundos/){:target="_blank"}
2. **Convertidor de temperatura**: Crea una página web que pida al usuario la
   ...
   [Comenzar](https://lab.cs50.io/merunga/admission-curriculum/rediseno-prework-fe/admission/03-prework/07-guided-exercises/sandboxes/02-convertidor-de-temperatura/){:target="_blank"}
3. **Ganancias y pérdidas**: Crea un programa que pide los ingresos, los costos
   ...
   imprimir el resultado en la web con el símbolo $ adelante. [Comenzar](https://lab.cs50.io/merunga/admission-curriculum/rediseno-prework-fe/admission/03-prework/07-guided-exercises/sandboxes/03-ganancias-y-perdidas/){:target="_blank"}
4. **Iniciales**: Crea un programa que pide el nombre y apellido al usuario. El
   ...
   "AM". "Michelle Seguil" y "michelle seguil" devuelven "MS". [Comenzar](https://lab.cs50.io/merunga/admission-curriculum/rediseno-prework-fe/admission/03-prework/07-guided-exercises/sandboxes/04-iniciales/){:target="_blank"}
